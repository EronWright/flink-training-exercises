...
public class RidesAndFares extends ExerciseBase {
	public static void main(String[] args) throws Exception {
		...
		String ridesStream = params.get("stream", "ridedata");
		...
		FlinkPravegaReader<TaxiRide> reader = FlinkPravegaReader.<TaxiRide>builder()
				.withPravegaConfig(pravegaConfig)
				.forStream(ridesStream)
				.withDeserializationSchema(PravegaSerialization.deserializationFor(TaxiRide.class))
				.build();
